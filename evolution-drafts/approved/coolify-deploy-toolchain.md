...
## 开发工具链
- Record important tools, services, and local setup here
- **Coolify**: platform PaaS self-hosted yang dipakai Rama utk deploy/redeploy app — saat ada tugas deploy/redeploy, cek dulu detail server & project Coolify-nya (mulai terlihat 2026-08-16)
