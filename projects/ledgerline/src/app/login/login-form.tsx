    ...
    <form onSubmit={onSubmit} className="mt-8 flex flex-col gap-4" noValidate={false}>
      <div className="flex flex-col gap-1.5">
        ...
        <input
          ...
          className="rounded-lg border border-line bg-background px-3.5 py-2.5 text-sm text-foreground placeholder:text-slate-700 focus:border-accent focus:outline-none focus:ring-2 focus:ring-accent/30"
        />
      </div>
