        ...
        <div className="flex gap-2">
          {FORMATS.map((f) => (
            <button
              ...
              className="flex items-center gap-1.5 rounded-lg border border-slate-600 bg-slate-800 px-3 py-2 text-xs font-medium text-slate-200 transition hover:border-yellow-400/50 hover:bg-slate-700 disabled:opacity-50"
            >
              <span>{f.icon}</span>
              {busy === f.key ? "..." : f.label}
            </button>
