...
async function main() {
  ...
  await page.waitForSelector("text=Workspace Dockable", { timeout: 20000 }).catch(()=>{});
  await page.waitForTimeout(2000);
  await page.screenshot({ path: ".openclaw/tmp/mod-37-dockable.png" });
  console.log("PASS: dockable screenshot");
  await browser.close();
}
