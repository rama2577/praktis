...
async function main() {
  ...
  await page.screenshot({ path: ".openclaw/tmp/mod-23-demo-dashboard.png", fullPage: false });
  await page.goto("https://web-production-7a593.up.railway.app/dashboard/clients", { waitUntil: "networkidle" });
  await page.waitForTimeout(1500);
  await page.screenshot({ path: ".openclaw/tmp/mod-24-demo-clients.png", fullPage: false });
  console.log("PASS: screenshot dashboard + clients");
  await browser.close();
}
