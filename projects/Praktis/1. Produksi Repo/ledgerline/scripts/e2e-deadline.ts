...
async function main() {
  ...
  await page.waitForSelector("text=Deadline terdekat", { timeout: 20000 });
  console.log("PASS: section deadline tampil");
  await page.screenshot({ path: ".openclaw/tmp/mod-22-daily-brief-deadline.png", fullPage: false });
  await browser.close();
}
