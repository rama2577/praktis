...
`/Users/staff/.openclaw-autoclaw/skills/<skill-name>/SKILL.md`
...
Call tools with: `mcporter --config /Users/staff/.openclaw-autoclaw/workspace/config/mcporter.json call <server>.<tool> key="value"`
